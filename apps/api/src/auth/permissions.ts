...
export const permissionCatalogue: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      permission("payments.capture", "Record manual payments", "Record money taken outside a gateway, such as a bank transfer.", "high"),
      permission("payments.refund", "Issue refunds", "Send refunds to the payment gateway or record a refund settled elsewhere.", "high"),
      permission("payments.reconcile", "Run reconciliation", "Re-query stale payments against the gateway and correct divergence.", "high"),
      permission("payments.export", "Export payments", "Download transaction records for finance."),
...
export const rolePermissions: Record<UserRole, string[]> = {
  ...
  OPERATIONS: [
    ...
    "refunds.read", "refunds.write", "payments.read", "payments.write",
    "payments.capture", "payments.refund", "payments.reconcile", "payments.export",
